...
// console.log(results.filter(m => m.freight < 1));
...
// let sayERNSH = (results.filter(m => m.order.customerId == "ERNSH"));
// console.log(sayERNSH.length);


// 3) employeeİd- görə sortlayın

// console.log(results.sort((m,n)=>m.order.employeeId-n.order.employeeId));
...
// console.log(results.filter(m => m.orderDetails.length>3));




// 5) İD-si 11075 olanı tap və yazdır. (find)
// console.log(results.find(m=>m.order.id===11075));